...
use Pixel\CoreBundle\Model\map\AuthorTableMap;
...
abstract class BaseAuthorPeer {
	...
	const OM_CLASS = 'Pixel\\CoreBundle\\Model\\Author';
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'FirstName', 'LastName', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'firstName', 'lastName', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::FIRST_NAME, self::LAST_NAME, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'FIRST_NAME', 'LAST_NAME', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'first_name', 'last_name', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'FirstName' => 1, 'LastName' => 2, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'firstName' => 1, 'lastName' => 2, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::FIRST_NAME => 1, self::LAST_NAME => 2, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'FIRST_NAME' => 1, 'LAST_NAME' => 2, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'first_name' => 1, 'last_name' => 2, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(AuthorPeer::FIRST_NAME);
	...
	public static function populateObject($row, $startcol = 0)
	{
		...
		if (null !== ($obj = AuthorPeer::getInstanceFromPool($key))) {
			...
			$col = $startcol + AuthorPeer::NUM_HYDRATE_COLUMNS;
		} else {
			$cls = AuthorPeer::OM_CLASS;
			$obj = new $cls();
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$value = $criteria->remove(AuthorPeer::ID);
			if ($value) {
				$selectCriteria->add(AuthorPeer::ID, $value, $comparison);
			} else {
				$selectCriteria->setPrimaryTableName(AuthorPeer::TABLE_NAME);
			}
